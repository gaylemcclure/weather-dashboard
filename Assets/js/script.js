...
const handlePreviousSearch = () => {
  ...
  if (saved !== null) {
    //Filter out duplicates of saved data
    ...
    //Map the arraty to create buttons. 
    uniqueArr.map((save) => {
      ...
      newButton.addEventListener("click", (e) => {
        ...
        //Removes previous before re-adding to avoid duplicates
        if (today === null) {
...
//Call function on load so previous searches appear
